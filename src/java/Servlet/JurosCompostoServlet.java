...
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            double valorFuturo = valor*Math.pow((1+(juros/100)),tempo);
            
            if(tempo <=1) {            
            out.println("<h2>O valor dos Juros Composto em "+tempo+" mês é de:</h2>");
            } else {
            out.println("<h2>O valor dos Juros Composto em "+tempo+" meses é de:</h2>");
            }
            out.println("<h2>R$"+valorFuturo+" Reais</h2>");
            out.println("<button><a href='index.html' >Voltar</a></button>");
            out.println("</body>");
            out.println("</html>");
        }
